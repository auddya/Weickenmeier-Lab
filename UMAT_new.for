...
! call F_g_sub(statev, nstatv, dtime, gnot, J, F, Fg, Fginv, detFg, fe, detfe)
      call F_g_sub(statev, nstatv, nshr, dtime, props, dfgrd1, felastic, 
     1               detfelastic)
      if (nshr.eq.1) then ! ###_ ac _ eq means =
...
!*********************************************************************
      ...
      subroutine F_g_sub(stv, nstv, knshr_test, udtime_test,  
